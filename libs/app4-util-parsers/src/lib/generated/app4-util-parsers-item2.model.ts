...
export class App4UtilParsersItem2Model implements IApp4UtilParsersItem2 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4UtilParsersItem2Status = undefined as any;
  enabled: App4UtilParsersItem2Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;

  constructor(data?: Partial<IApp4UtilParsersItem2>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4UtilParsersItem2 {
    return { ...this } as IApp4UtilParsersItem2;
  }

  clone(): App4UtilParsersItem2Model {
    return new App4UtilParsersItem2Model(this.toJSON());
  }
