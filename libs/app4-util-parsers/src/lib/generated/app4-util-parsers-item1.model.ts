...
export class App4UtilParsersItem1Model implements IApp4UtilParsersItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4UtilParsersItem1Status = undefined as any;
  enabled: App4UtilParsersItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp4UtilParsersItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4UtilParsersItem1 {
    return { ...this } as IApp4UtilParsersItem1;
  }

  clone(): App4UtilParsersItem1Model {
    return new App4UtilParsersItem1Model(this.toJSON());
  }
