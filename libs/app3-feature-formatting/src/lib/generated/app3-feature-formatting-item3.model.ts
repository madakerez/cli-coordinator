...
export class App3FeatureFormattingItem3Model implements IApp3FeatureFormattingItem3 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App3FeatureFormattingItem3Status = undefined as any;
  enabled: App3FeatureFormattingItem3Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App3FeatureFormattingItem3Status = undefined as any;

  constructor(data?: Partial<IApp3FeatureFormattingItem3>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp3FeatureFormattingItem3 {
    return { ...this } as IApp3FeatureFormattingItem3;
  }

  clone(): App3FeatureFormattingItem3Model {
    return new App3FeatureFormattingItem3Model(this.toJSON());
  }
