...
export class App3FeatureFormattingItem1Model implements IApp3FeatureFormattingItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App3FeatureFormattingItem1Status = undefined as any;
  enabled: App3FeatureFormattingItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp3FeatureFormattingItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp3FeatureFormattingItem1 {
    return { ...this } as IApp3FeatureFormattingItem1;
  }

  clone(): App3FeatureFormattingItem1Model {
    return new App3FeatureFormattingItem1Model(this.toJSON());
  }
