...
export class App4FeatureDashboardsItem2Model implements IApp4FeatureDashboardsItem2 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureDashboardsItem2Status = undefined as any;
  enabled: App4FeatureDashboardsItem2Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;

  constructor(data?: Partial<IApp4FeatureDashboardsItem2>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureDashboardsItem2 {
    return { ...this } as IApp4FeatureDashboardsItem2;
  }

  clone(): App4FeatureDashboardsItem2Model {
    return new App4FeatureDashboardsItem2Model(this.toJSON());
  }
