...
export class App4FeatureDashboardsItem3Model implements IApp4FeatureDashboardsItem3 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureDashboardsItem3Status = undefined as any;
  enabled: App4FeatureDashboardsItem3Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App4FeatureDashboardsItem3Status = undefined as any;

  constructor(data?: Partial<IApp4FeatureDashboardsItem3>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureDashboardsItem3 {
    return { ...this } as IApp4FeatureDashboardsItem3;
  }

  clone(): App4FeatureDashboardsItem3Model {
    return new App4FeatureDashboardsItem3Model(this.toJSON());
  }
