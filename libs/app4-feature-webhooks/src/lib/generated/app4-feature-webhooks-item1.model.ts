...
export class App4FeatureWebhooksItem1Model implements IApp4FeatureWebhooksItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureWebhooksItem1Status = undefined as any;
  enabled: App4FeatureWebhooksItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp4FeatureWebhooksItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureWebhooksItem1 {
    return { ...this } as IApp4FeatureWebhooksItem1;
  }

  clone(): App4FeatureWebhooksItem1Model {
    return new App4FeatureWebhooksItem1Model(this.toJSON());
  }
