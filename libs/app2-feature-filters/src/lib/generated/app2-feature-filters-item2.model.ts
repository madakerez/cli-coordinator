...
export class App2FeatureFiltersItem2Model implements IApp2FeatureFiltersItem2 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App2FeatureFiltersItem2Status = undefined as any;
  enabled: App2FeatureFiltersItem2Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;

  constructor(data?: Partial<IApp2FeatureFiltersItem2>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp2FeatureFiltersItem2 {
    return { ...this } as IApp2FeatureFiltersItem2;
  }

  clone(): App2FeatureFiltersItem2Model {
    return new App2FeatureFiltersItem2Model(this.toJSON());
  }
