...
export function createApp3FeatureAnalyticsItem2(data: Partial<IApp3FeatureAnalyticsItem2> = {}): IApp3FeatureAnalyticsItem2 {
  return {
    id: '',
    name: '',
    label: '',
    ...
    updatedAt: new Date(),
    ...data,
  } as IApp3FeatureAnalyticsItem2;
}

export function validateApp3FeatureAnalyticsItem2(entity: IApp3FeatureAnalyticsItem2): string[] {
  const errors: string[] = [];
...
export function cloneApp3FeatureAnalyticsItem2(entity: IApp3FeatureAnalyticsItem2): IApp3FeatureAnalyticsItem2 {
  return { ...entity };
}