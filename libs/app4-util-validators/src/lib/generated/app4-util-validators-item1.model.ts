...
export class App4UtilValidatorsItem1Model implements IApp4UtilValidatorsItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4UtilValidatorsItem1Status = undefined as any;
  enabled: App4UtilValidatorsItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp4UtilValidatorsItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4UtilValidatorsItem1 {
    return { ...this } as IApp4UtilValidatorsItem1;
  }

  clone(): App4UtilValidatorsItem1Model {
    return new App4UtilValidatorsItem1Model(this.toJSON());
  }
