...
export class App1FeatureNotificationsItem0Model implements IApp1FeatureNotificationsItem0 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureNotificationsItem0Status = undefined as any;
  enabled: App1FeatureNotificationsItem0Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;

  constructor(data?: Partial<IApp1FeatureNotificationsItem0>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureNotificationsItem0 {
    return { ...this } as IApp1FeatureNotificationsItem0;
  }

  clone(): App1FeatureNotificationsItem0Model {
    return new App1FeatureNotificationsItem0Model(this.toJSON());
  }
