...
export class App1FeatureNotificationsItem10Model implements IApp1FeatureNotificationsItem10 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureNotificationsItem10Status = undefined as any;
  enabled: App1FeatureNotificationsItem10Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App1FeatureNotificationsItem10Status = undefined as any;
  category: App1FeatureNotificationsItem10Type = undefined as any;
  tags: string = undefined as any;
  config: number = undefined as any;
  options: boolean = undefined as any;
  parentId: Date = undefined as any;
  ownerId: App1FeatureNotificationsItem10Status = undefined as any;
  status: App1FeatureNotificationsItem10Type = undefined as any;

  constructor(data?: Partial<IApp1FeatureNotificationsItem10>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureNotificationsItem10 {
    return { ...this } as IApp1FeatureNotificationsItem10;
  }

  clone(): App1FeatureNotificationsItem10Model {
    return new App1FeatureNotificationsItem10Model(this.toJSON());
  }
