...
export class App1FeatureNotificationsSvc9Service {
  cache = new Map<string, App1FeatureNotificationsSvc9CacheEntry<unknown>>();
  requestQueue: Array<() => Promise<void>> = [];
  processing = false;
  config: App1FeatureNotificationsSvc9ServiceConfig;

  constructor(config: App1FeatureNotificationsSvc9ServiceConfig) {
    this.config = config;
  }
