...
export class App1FeatureNotificationsItem5Model implements IApp1FeatureNotificationsItem5 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureNotificationsItem5Status = undefined as any;
  enabled: App1FeatureNotificationsItem5Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App1FeatureNotificationsItem5Status = undefined as any;
  category: App1FeatureNotificationsItem5Type = undefined as any;
  tags: string = undefined as any;

  constructor(data?: Partial<IApp1FeatureNotificationsItem5>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureNotificationsItem5 {
    return { ...this } as IApp1FeatureNotificationsItem5;
  }

  clone(): App1FeatureNotificationsItem5Model {
    return new App1FeatureNotificationsItem5Model(this.toJSON());
  }
