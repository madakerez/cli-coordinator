...
import type { IApp1FeatureNotificationsItem13, App1FeatureNotificationsItem13Status } from './app1-feature-notifications-item13.model';
...
export class App1FeatureNotificationsSvc11Service {
  cache = new Map<string, App1FeatureNotificationsSvc11CacheEntry<unknown>>();
  requestQueue: Array<() => Promise<void>> = [];
  processing = false;
  config: App1FeatureNotificationsSvc11ServiceConfig;

  constructor(config: App1FeatureNotificationsSvc11ServiceConfig) {
    this.config = config;
  }
