...
export class App1FeatureNotificationsItem2Model implements IApp1FeatureNotificationsItem2 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureNotificationsItem2Status = undefined as any;
  enabled: App1FeatureNotificationsItem2Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;

  constructor(data?: Partial<IApp1FeatureNotificationsItem2>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureNotificationsItem2 {
    return { ...this } as IApp1FeatureNotificationsItem2;
  }

  clone(): App1FeatureNotificationsItem2Model {
    return new App1FeatureNotificationsItem2Model(this.toJSON());
  }
