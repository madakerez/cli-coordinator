...
export class App1FeatureNotificationsItem16Model implements IApp1FeatureNotificationsItem16 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureNotificationsItem16Status = undefined as any;
  enabled: App1FeatureNotificationsItem16Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App1FeatureNotificationsItem16Status = undefined as any;
  category: App1FeatureNotificationsItem16Type = undefined as any;

  constructor(data?: Partial<IApp1FeatureNotificationsItem16>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureNotificationsItem16 {
    return { ...this } as IApp1FeatureNotificationsItem16;
  }

  clone(): App1FeatureNotificationsItem16Model {
    return new App1FeatureNotificationsItem16Model(this.toJSON());
  }
