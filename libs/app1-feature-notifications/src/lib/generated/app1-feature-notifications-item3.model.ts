...
export class App1FeatureNotificationsItem3Model implements IApp1FeatureNotificationsItem3 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureNotificationsItem3Status = undefined as any;
  enabled: App1FeatureNotificationsItem3Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App1FeatureNotificationsItem3Status = undefined as any;

  constructor(data?: Partial<IApp1FeatureNotificationsItem3>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureNotificationsItem3 {
    return { ...this } as IApp1FeatureNotificationsItem3;
  }

  clone(): App1FeatureNotificationsItem3Model {
    return new App1FeatureNotificationsItem3Model(this.toJSON());
  }
