...
export class App1FeatureNotificationsItem9Model implements IApp1FeatureNotificationsItem9 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureNotificationsItem9Status = undefined as any;
  enabled: App1FeatureNotificationsItem9Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App1FeatureNotificationsItem9Status = undefined as any;
  category: App1FeatureNotificationsItem9Type = undefined as any;
  tags: string = undefined as any;
  config: number = undefined as any;
  options: boolean = undefined as any;
  parentId: Date = undefined as any;
  ownerId: App1FeatureNotificationsItem9Status = undefined as any;

  constructor(data?: Partial<IApp1FeatureNotificationsItem9>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureNotificationsItem9 {
    return { ...this } as IApp1FeatureNotificationsItem9;
  }

  clone(): App1FeatureNotificationsItem9Model {
    return new App1FeatureNotificationsItem9Model(this.toJSON());
  }
