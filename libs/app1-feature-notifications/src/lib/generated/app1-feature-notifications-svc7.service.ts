...
export class App1FeatureNotificationsSvc7Service {
  cache = new Map<string, App1FeatureNotificationsSvc7CacheEntry<unknown>>();
  requestQueue: Array<() => Promise<void>> = [];
  processing = false;
  config: App1FeatureNotificationsSvc7ServiceConfig;

  constructor(config: App1FeatureNotificationsSvc7ServiceConfig) {
    this.config = config;
  }
