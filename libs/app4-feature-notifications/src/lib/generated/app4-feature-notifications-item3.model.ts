...
export class App4FeatureNotificationsItem3Model implements IApp4FeatureNotificationsItem3 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureNotificationsItem3Status = undefined as any;
  enabled: App4FeatureNotificationsItem3Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App4FeatureNotificationsItem3Status = undefined as any;

  constructor(data?: Partial<IApp4FeatureNotificationsItem3>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureNotificationsItem3 {
    return { ...this } as IApp4FeatureNotificationsItem3;
  }

  clone(): App4FeatureNotificationsItem3Model {
    return new App4FeatureNotificationsItem3Model(this.toJSON());
  }
