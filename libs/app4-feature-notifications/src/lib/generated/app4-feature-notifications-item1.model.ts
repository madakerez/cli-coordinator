...
export class App4FeatureNotificationsItem1Model implements IApp4FeatureNotificationsItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureNotificationsItem1Status = undefined as any;
  enabled: App4FeatureNotificationsItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp4FeatureNotificationsItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureNotificationsItem1 {
    return { ...this } as IApp4FeatureNotificationsItem1;
  }

  clone(): App4FeatureNotificationsItem1Model {
    return new App4FeatureNotificationsItem1Model(this.toJSON());
  }
