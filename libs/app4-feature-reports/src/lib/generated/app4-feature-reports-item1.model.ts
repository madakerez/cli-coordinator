...
export class App4FeatureReportsItem1Model implements IApp4FeatureReportsItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureReportsItem1Status = undefined as any;
  enabled: App4FeatureReportsItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp4FeatureReportsItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureReportsItem1 {
    return { ...this } as IApp4FeatureReportsItem1;
  }

  clone(): App4FeatureReportsItem1Model {
    return new App4FeatureReportsItem1Model(this.toJSON());
  }
