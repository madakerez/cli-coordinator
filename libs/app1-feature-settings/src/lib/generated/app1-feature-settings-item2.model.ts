...
export function createApp1FeatureSettingsItem2(data: Partial<IApp1FeatureSettingsItem2> = {}): IApp1FeatureSettingsItem2 {
  return {
    id: '',
    name: '',
    label: '',
    ...
    updatedAt: new Date(),
    ...data,
  } as IApp1FeatureSettingsItem2;
}

export function validateApp1FeatureSettingsItem2(entity: IApp1FeatureSettingsItem2): string[] {
  const errors: string[] = [];
...
export function cloneApp1FeatureSettingsItem2(entity: IApp1FeatureSettingsItem2): IApp1FeatureSettingsItem2 {
  return { ...entity };
}