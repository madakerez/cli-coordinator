...
export class App1FeatureSettingsItem7Model implements IApp1FeatureSettingsItem7 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureSettingsItem7Status = undefined as any;
  enabled: App1FeatureSettingsItem7Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App1FeatureSettingsItem7Status = undefined as any;
  category: App1FeatureSettingsItem7Type = undefined as any;
  tags: string = undefined as any;
  config: number = undefined as any;
  options: boolean = undefined as any;

  constructor(data?: Partial<IApp1FeatureSettingsItem7>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureSettingsItem7 {
    return { ...this } as IApp1FeatureSettingsItem7;
  }

  clone(): App1FeatureSettingsItem7Model {
    return new App1FeatureSettingsItem7Model(this.toJSON());
  }
