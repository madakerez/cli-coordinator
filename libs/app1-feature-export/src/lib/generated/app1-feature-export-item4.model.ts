...
export class App1FeatureExportItem4Model implements IApp1FeatureExportItem4 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureExportItem4Status = undefined as any;
  enabled: App1FeatureExportItem4Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App1FeatureExportItem4Status = undefined as any;
  category: App1FeatureExportItem4Type = undefined as any;

  constructor(data?: Partial<IApp1FeatureExportItem4>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureExportItem4 {
    return { ...this } as IApp1FeatureExportItem4;
  }

  clone(): App1FeatureExportItem4Model {
    return new App1FeatureExportItem4Model(this.toJSON());
  }
