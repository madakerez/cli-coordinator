...
export class App1FeatureExportItem13Model implements IApp1FeatureExportItem13 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureExportItem13Status = undefined as any;
  enabled: App1FeatureExportItem13Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp1FeatureExportItem13>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureExportItem13 {
    return { ...this } as IApp1FeatureExportItem13;
  }

  clone(): App1FeatureExportItem13Model {
    return new App1FeatureExportItem13Model(this.toJSON());
  }
