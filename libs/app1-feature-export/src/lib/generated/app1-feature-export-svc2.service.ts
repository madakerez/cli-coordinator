...
export class App1FeatureExportSvc2Service {
  cache = new Map<string, App1FeatureExportSvc2CacheEntry<unknown>>();
  requestQueue: Array<() => Promise<void>> = [];
  processing = false;
  config: App1FeatureExportSvc2ServiceConfig;

  constructor(config: App1FeatureExportSvc2ServiceConfig) {
    this.config = config;
  }
