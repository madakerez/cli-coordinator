...
export class App1FeatureExportSvc3Service {
  cache = new Map<string, App1FeatureExportSvc3CacheEntry<unknown>>();
  requestQueue: Array<() => Promise<void>> = [];
  processing = false;
  config: App1FeatureExportSvc3ServiceConfig;

  constructor(config: App1FeatureExportSvc3ServiceConfig) {
    this.config = config;
  }
