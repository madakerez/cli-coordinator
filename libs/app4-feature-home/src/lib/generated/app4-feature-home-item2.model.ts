...
export class App4FeatureHomeItem2Model implements IApp4FeatureHomeItem2 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureHomeItem2Status = undefined as any;
  enabled: App4FeatureHomeItem2Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;

  constructor(data?: Partial<IApp4FeatureHomeItem2>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureHomeItem2 {
    return { ...this } as IApp4FeatureHomeItem2;
  }

  clone(): App4FeatureHomeItem2Model {
    return new App4FeatureHomeItem2Model(this.toJSON());
  }
