...
export class App1FeatureBillingItem5Model implements IApp1FeatureBillingItem5 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureBillingItem5Status = undefined as any;
  enabled: App1FeatureBillingItem5Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App1FeatureBillingItem5Status = undefined as any;
  category: App1FeatureBillingItem5Type = undefined as any;
  tags: string = undefined as any;

  constructor(data?: Partial<IApp1FeatureBillingItem5>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureBillingItem5 {
    return { ...this } as IApp1FeatureBillingItem5;
  }

  clone(): App1FeatureBillingItem5Model {
    return new App1FeatureBillingItem5Model(this.toJSON());
  }
