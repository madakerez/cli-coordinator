...
export class App1FeatureBillingItem1Model implements IApp1FeatureBillingItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureBillingItem1Status = undefined as any;
  enabled: App1FeatureBillingItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp1FeatureBillingItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureBillingItem1 {
    return { ...this } as IApp1FeatureBillingItem1;
  }

  clone(): App1FeatureBillingItem1Model {
    return new App1FeatureBillingItem1Model(this.toJSON());
  }
