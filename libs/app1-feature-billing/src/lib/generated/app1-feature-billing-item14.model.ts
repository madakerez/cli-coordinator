...
export class App1FeatureBillingItem14Model implements IApp1FeatureBillingItem14 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureBillingItem14Status = undefined as any;
  enabled: App1FeatureBillingItem14Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;

  constructor(data?: Partial<IApp1FeatureBillingItem14>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureBillingItem14 {
    return { ...this } as IApp1FeatureBillingItem14;
  }

  clone(): App1FeatureBillingItem14Model {
    return new App1FeatureBillingItem14Model(this.toJSON());
  }
