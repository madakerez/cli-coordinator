...
export class App1FeatureBillingSvc6Service {
  cache = new Map<string, App1FeatureBillingSvc6CacheEntry<unknown>>();
  requestQueue: Array<() => Promise<void>> = [];
  processing = false;
  config: App1FeatureBillingSvc6ServiceConfig;

  constructor(config: App1FeatureBillingSvc6ServiceConfig) {
    this.config = config;
  }
