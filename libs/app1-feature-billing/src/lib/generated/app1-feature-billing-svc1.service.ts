...
export class App1FeatureBillingSvc1Service {
  cache = new Map<string, App1FeatureBillingSvc1CacheEntry<unknown>>();
  requestQueue: Array<() => Promise<void>> = [];
  processing = false;
  config: App1FeatureBillingSvc1ServiceConfig;

  constructor(config: App1FeatureBillingSvc1ServiceConfig) {
    this.config = config;
  }
