...
export class App1FeatureBillingItem6Model implements IApp1FeatureBillingItem6 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureBillingItem6Status = undefined as any;
  enabled: App1FeatureBillingItem6Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App1FeatureBillingItem6Status = undefined as any;
  category: App1FeatureBillingItem6Type = undefined as any;
  tags: string = undefined as any;
  config: number = undefined as any;

  constructor(data?: Partial<IApp1FeatureBillingItem6>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureBillingItem6 {
    return { ...this } as IApp1FeatureBillingItem6;
  }

  clone(): App1FeatureBillingItem6Model {
    return new App1FeatureBillingItem6Model(this.toJSON());
  }
