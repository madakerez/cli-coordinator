import { IApp1FeatureBillingItem0, App1FeatureBillingItem0Model, App1FeatureBillingItem0Status, App1FeatureBillingItem0Filter } from './app1-feature-billing-item0.model';
...
export class App1FeatureBillingSvc0Service {
  private cache = new Map<string, App1FeatureBillingSvc0CacheEntry<unknown>>();
  private requestQueue: Array<() => Promise<void>> = [];
  private processing = false;

  constructor(private config: App1FeatureBillingSvc0ServiceConfig) {}
