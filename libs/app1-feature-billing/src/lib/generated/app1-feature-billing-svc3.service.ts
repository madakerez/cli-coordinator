...
export class App1FeatureBillingSvc3Service {
  cache = new Map<string, App1FeatureBillingSvc3CacheEntry<unknown>>();
  requestQueue: Array<() => Promise<void>> = [];
  processing = false;
  config: App1FeatureBillingSvc3ServiceConfig;

  constructor(config: App1FeatureBillingSvc3ServiceConfig) {
    this.config = config;
  }
