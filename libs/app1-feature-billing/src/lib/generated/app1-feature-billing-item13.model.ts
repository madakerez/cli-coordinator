...
export class App1FeatureBillingItem13Model implements IApp1FeatureBillingItem13 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureBillingItem13Status = undefined as any;
  enabled: App1FeatureBillingItem13Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp1FeatureBillingItem13>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureBillingItem13 {
    return { ...this } as IApp1FeatureBillingItem13;
  }

  clone(): App1FeatureBillingItem13Model {
    return new App1FeatureBillingItem13Model(this.toJSON());
  }
