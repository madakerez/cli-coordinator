...
export class App1FeatureBillingItem3Model implements IApp1FeatureBillingItem3 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureBillingItem3Status = undefined as any;
  enabled: App1FeatureBillingItem3Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App1FeatureBillingItem3Status = undefined as any;

  constructor(data?: Partial<IApp1FeatureBillingItem3>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureBillingItem3 {
    return { ...this } as IApp1FeatureBillingItem3;
  }

  clone(): App1FeatureBillingItem3Model {
    return new App1FeatureBillingItem3Model(this.toJSON());
  }
