...
export class App1FeatureTasksItem2Model implements IApp1FeatureTasksItem2 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureTasksItem2Status = undefined as any;
  enabled: App1FeatureTasksItem2Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;

  constructor(data?: Partial<IApp1FeatureTasksItem2>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureTasksItem2 {
    return { ...this } as IApp1FeatureTasksItem2;
  }

  clone(): App1FeatureTasksItem2Model {
    return new App1FeatureTasksItem2Model(this.toJSON());
  }
