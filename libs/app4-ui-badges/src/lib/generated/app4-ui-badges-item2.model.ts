...
export class App4UiBadgesItem2Model implements IApp4UiBadgesItem2 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4UiBadgesItem2Status = undefined as any;
  enabled: App4UiBadgesItem2Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;

  constructor(data?: Partial<IApp4UiBadgesItem2>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4UiBadgesItem2 {
    return { ...this } as IApp4UiBadgesItem2;
  }

  clone(): App4UiBadgesItem2Model {
    return new App4UiBadgesItem2Model(this.toJSON());
  }
