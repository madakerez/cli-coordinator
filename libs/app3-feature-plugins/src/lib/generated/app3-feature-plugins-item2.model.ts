...
export class App3FeaturePluginsItem2Model implements IApp3FeaturePluginsItem2 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App3FeaturePluginsItem2Status = undefined as any;
  enabled: App3FeaturePluginsItem2Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;

  constructor(data?: Partial<IApp3FeaturePluginsItem2>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp3FeaturePluginsItem2 {
    return { ...this } as IApp3FeaturePluginsItem2;
  }

  clone(): App3FeaturePluginsItem2Model {
    return new App3FeaturePluginsItem2Model(this.toJSON());
  }
