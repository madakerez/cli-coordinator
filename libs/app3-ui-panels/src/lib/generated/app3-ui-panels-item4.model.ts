...
export class App3UiPanelsItem4Model implements IApp3UiPanelsItem4 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App3UiPanelsItem4Status = undefined as any;
  enabled: App3UiPanelsItem4Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App3UiPanelsItem4Status = undefined as any;
  category: App3UiPanelsItem4Type = undefined as any;

  constructor(data?: Partial<IApp3UiPanelsItem4>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp3UiPanelsItem4 {
    return { ...this } as IApp3UiPanelsItem4;
  }

  clone(): App3UiPanelsItem4Model {
    return new App3UiPanelsItem4Model(this.toJSON());
  }
