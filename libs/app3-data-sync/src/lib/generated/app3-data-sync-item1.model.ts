...
export class App3DataSyncItem1Model implements IApp3DataSyncItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App3DataSyncItem1Status = undefined as any;
  enabled: App3DataSyncItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp3DataSyncItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp3DataSyncItem1 {
    return { ...this } as IApp3DataSyncItem1;
  }

  clone(): App3DataSyncItem1Model {
    return new App3DataSyncItem1Model(this.toJSON());
  }
