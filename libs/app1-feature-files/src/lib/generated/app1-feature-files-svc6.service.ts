...
export class App1FeatureFilesSvc6Service {
  cache = new Map<string, App1FeatureFilesSvc6CacheEntry<unknown>>();
  requestQueue: Array<() => Promise<void>> = [];
  processing = false;
  config: App1FeatureFilesSvc6ServiceConfig;

  constructor(config: App1FeatureFilesSvc6ServiceConfig) {
    this.config = config;
  }
