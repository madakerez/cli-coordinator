...
export class App1FeatureFilesSvc5Service {
  cache = new Map<string, App1FeatureFilesSvc5CacheEntry<unknown>>();
  requestQueue: Array<() => Promise<void>> = [];
  processing = false;
  config: App1FeatureFilesSvc5ServiceConfig;

  constructor(config: App1FeatureFilesSvc5ServiceConfig) {
    this.config = config;
  }
