...
export class App1FeatureFilesItem4Model implements IApp1FeatureFilesItem4 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureFilesItem4Status = undefined as any;
  enabled: App1FeatureFilesItem4Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App1FeatureFilesItem4Status = undefined as any;
  category: App1FeatureFilesItem4Type = undefined as any;

  constructor(data?: Partial<IApp1FeatureFilesItem4>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureFilesItem4 {
    return { ...this } as IApp1FeatureFilesItem4;
  }

  clone(): App1FeatureFilesItem4Model {
    return new App1FeatureFilesItem4Model(this.toJSON());
  }
