...
export class App1FeatureFilesItem7Model implements IApp1FeatureFilesItem7 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureFilesItem7Status = undefined as any;
  enabled: App1FeatureFilesItem7Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App1FeatureFilesItem7Status = undefined as any;
  category: App1FeatureFilesItem7Type = undefined as any;
  tags: string = undefined as any;
  config: number = undefined as any;
  options: boolean = undefined as any;

  constructor(data?: Partial<IApp1FeatureFilesItem7>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureFilesItem7 {
    return { ...this } as IApp1FeatureFilesItem7;
  }

  clone(): App1FeatureFilesItem7Model {
    return new App1FeatureFilesItem7Model(this.toJSON());
  }
