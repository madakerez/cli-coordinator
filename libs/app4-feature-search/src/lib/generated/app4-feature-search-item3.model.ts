...
export class App4FeatureSearchItem3Model implements IApp4FeatureSearchItem3 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureSearchItem3Status = undefined as any;
  enabled: App4FeatureSearchItem3Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App4FeatureSearchItem3Status = undefined as any;

  constructor(data?: Partial<IApp4FeatureSearchItem3>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureSearchItem3 {
    return { ...this } as IApp4FeatureSearchItem3;
  }

  clone(): App4FeatureSearchItem3Model {
    return new App4FeatureSearchItem3Model(this.toJSON());
  }
