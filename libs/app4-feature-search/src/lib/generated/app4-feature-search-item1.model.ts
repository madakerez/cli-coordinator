...
export class App4FeatureSearchItem1Model implements IApp4FeatureSearchItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureSearchItem1Status = undefined as any;
  enabled: App4FeatureSearchItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp4FeatureSearchItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureSearchItem1 {
    return { ...this } as IApp4FeatureSearchItem1;
  }

  clone(): App4FeatureSearchItem1Model {
    return new App4FeatureSearchItem1Model(this.toJSON());
  }
