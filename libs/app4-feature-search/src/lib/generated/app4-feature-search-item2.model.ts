...
export class App4FeatureSearchItem2Model implements IApp4FeatureSearchItem2 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureSearchItem2Status = undefined as any;
  enabled: App4FeatureSearchItem2Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;

  constructor(data?: Partial<IApp4FeatureSearchItem2>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureSearchItem2 {
    return { ...this } as IApp4FeatureSearchItem2;
  }

  clone(): App4FeatureSearchItem2Model {
    return new App4FeatureSearchItem2Model(this.toJSON());
  }
