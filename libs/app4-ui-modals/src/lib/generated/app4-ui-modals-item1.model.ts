...
export function createApp4UiModalsItem1(data: Partial<IApp4UiModalsItem1> = {}): IApp4UiModalsItem1 {
  return {
    id: '',
    name: '',
    label: '',
    ...
    updatedAt: new Date(),
    ...data,
  } as IApp4UiModalsItem1;
}

export function validateApp4UiModalsItem1(entity: IApp4UiModalsItem1): string[] {
  const errors: string[] = [];
...
export function cloneApp4UiModalsItem1(entity: IApp4UiModalsItem1): IApp4UiModalsItem1 {
  return { ...entity };
}