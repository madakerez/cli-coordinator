...
export class App4UiChartsItem3Model implements IApp4UiChartsItem3 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4UiChartsItem3Status = undefined as any;
  enabled: App4UiChartsItem3Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App4UiChartsItem3Status = undefined as any;

  constructor(data?: Partial<IApp4UiChartsItem3>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4UiChartsItem3 {
    return { ...this } as IApp4UiChartsItem3;
  }

  clone(): App4UiChartsItem3Model {
    return new App4UiChartsItem3Model(this.toJSON());
  }
