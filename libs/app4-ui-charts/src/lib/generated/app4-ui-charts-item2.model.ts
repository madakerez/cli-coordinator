...
export class App4UiChartsItem2Model implements IApp4UiChartsItem2 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4UiChartsItem2Status = undefined as any;
  enabled: App4UiChartsItem2Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;

  constructor(data?: Partial<IApp4UiChartsItem2>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4UiChartsItem2 {
    return { ...this } as IApp4UiChartsItem2;
  }

  clone(): App4UiChartsItem2Model {
    return new App4UiChartsItem2Model(this.toJSON());
  }
