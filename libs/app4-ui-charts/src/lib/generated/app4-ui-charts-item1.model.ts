...
export class App4UiChartsItem1Model implements IApp4UiChartsItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4UiChartsItem1Status = undefined as any;
  enabled: App4UiChartsItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp4UiChartsItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4UiChartsItem1 {
    return { ...this } as IApp4UiChartsItem1;
  }

  clone(): App4UiChartsItem1Model {
    return new App4UiChartsItem1Model(this.toJSON());
  }
