...
export class App4UiChartsItem7Model implements IApp4UiChartsItem7 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4UiChartsItem7Status = undefined as any;
  enabled: App4UiChartsItem7Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App4UiChartsItem7Status = undefined as any;
  category: App4UiChartsItem7Type = undefined as any;
  tags: string = undefined as any;
  config: number = undefined as any;
  options: boolean = undefined as any;

  constructor(data?: Partial<IApp4UiChartsItem7>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4UiChartsItem7 {
    return { ...this } as IApp4UiChartsItem7;
  }

  clone(): App4UiChartsItem7Model {
    return new App4UiChartsItem7Model(this.toJSON());
  }
