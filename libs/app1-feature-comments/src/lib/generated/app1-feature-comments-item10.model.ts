...
export class App1FeatureCommentsItem10Model implements IApp1FeatureCommentsItem10 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureCommentsItem10Status = undefined as any;
  enabled: App1FeatureCommentsItem10Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App1FeatureCommentsItem10Status = undefined as any;
  category: App1FeatureCommentsItem10Type = undefined as any;
  tags: string = undefined as any;
  config: number = undefined as any;
  options: boolean = undefined as any;
  parentId: Date = undefined as any;
  ownerId: App1FeatureCommentsItem10Status = undefined as any;
  status: App1FeatureCommentsItem10Type = undefined as any;

  constructor(data?: Partial<IApp1FeatureCommentsItem10>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureCommentsItem10 {
    return { ...this } as IApp1FeatureCommentsItem10;
  }

  clone(): App1FeatureCommentsItem10Model {
    return new App1FeatureCommentsItem10Model(this.toJSON());
  }
