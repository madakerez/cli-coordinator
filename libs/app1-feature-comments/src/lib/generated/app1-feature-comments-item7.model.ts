...
export class App1FeatureCommentsItem7Model implements IApp1FeatureCommentsItem7 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureCommentsItem7Status = undefined as any;
  enabled: App1FeatureCommentsItem7Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App1FeatureCommentsItem7Status = undefined as any;
  category: App1FeatureCommentsItem7Type = undefined as any;
  tags: string = undefined as any;
  config: number = undefined as any;
  options: boolean = undefined as any;

  constructor(data?: Partial<IApp1FeatureCommentsItem7>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureCommentsItem7 {
    return { ...this } as IApp1FeatureCommentsItem7;
  }

  clone(): App1FeatureCommentsItem7Model {
    return new App1FeatureCommentsItem7Model(this.toJSON());
  }
