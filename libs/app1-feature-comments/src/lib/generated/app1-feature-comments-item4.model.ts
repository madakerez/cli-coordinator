...
export class App1FeatureCommentsItem4Model implements IApp1FeatureCommentsItem4 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureCommentsItem4Status = undefined as any;
  enabled: App1FeatureCommentsItem4Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App1FeatureCommentsItem4Status = undefined as any;
  category: App1FeatureCommentsItem4Type = undefined as any;

  constructor(data?: Partial<IApp1FeatureCommentsItem4>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureCommentsItem4 {
    return { ...this } as IApp1FeatureCommentsItem4;
  }

  clone(): App1FeatureCommentsItem4Model {
    return new App1FeatureCommentsItem4Model(this.toJSON());
  }
