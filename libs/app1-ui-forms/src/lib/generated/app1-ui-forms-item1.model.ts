...
export class App1UiFormsItem1Model implements IApp1UiFormsItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1UiFormsItem1Status = undefined as any;
  enabled: App1UiFormsItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp1UiFormsItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1UiFormsItem1 {
    return { ...this } as IApp1UiFormsItem1;
  }

  clone(): App1UiFormsItem1Model {
    return new App1UiFormsItem1Model(this.toJSON());
  }
