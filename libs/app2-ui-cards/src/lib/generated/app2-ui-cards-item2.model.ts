...
export class App2UiCardsItem2Model implements IApp2UiCardsItem2 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App2UiCardsItem2Status = undefined as any;
  enabled: App2UiCardsItem2Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;

  constructor(data?: Partial<IApp2UiCardsItem2>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp2UiCardsItem2 {
    return { ...this } as IApp2UiCardsItem2;
  }

  clone(): App2UiCardsItem2Model {
    return new App2UiCardsItem2Model(this.toJSON());
  }
