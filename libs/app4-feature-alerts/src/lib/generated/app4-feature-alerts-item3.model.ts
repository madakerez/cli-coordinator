...
export class App4FeatureAlertsItem3Model implements IApp4FeatureAlertsItem3 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureAlertsItem3Status = undefined as any;
  enabled: App4FeatureAlertsItem3Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App4FeatureAlertsItem3Status = undefined as any;

  constructor(data?: Partial<IApp4FeatureAlertsItem3>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureAlertsItem3 {
    return { ...this } as IApp4FeatureAlertsItem3;
  }

  clone(): App4FeatureAlertsItem3Model {
    return new App4FeatureAlertsItem3Model(this.toJSON());
  }
