...
export class App4FeatureAlertsItem4Model implements IApp4FeatureAlertsItem4 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureAlertsItem4Status = undefined as any;
  enabled: App4FeatureAlertsItem4Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App4FeatureAlertsItem4Status = undefined as any;
  category: App4FeatureAlertsItem4Type = undefined as any;

  constructor(data?: Partial<IApp4FeatureAlertsItem4>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureAlertsItem4 {
    return { ...this } as IApp4FeatureAlertsItem4;
  }

  clone(): App4FeatureAlertsItem4Model {
    return new App4FeatureAlertsItem4Model(this.toJSON());
  }
