...
export class App4FeatureAlertsItem2Model implements IApp4FeatureAlertsItem2 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureAlertsItem2Status = undefined as any;
  enabled: App4FeatureAlertsItem2Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;

  constructor(data?: Partial<IApp4FeatureAlertsItem2>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureAlertsItem2 {
    return { ...this } as IApp4FeatureAlertsItem2;
  }

  clone(): App4FeatureAlertsItem2Model {
    return new App4FeatureAlertsItem2Model(this.toJSON());
  }
