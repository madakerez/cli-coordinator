...
export class App1DataCacheItem1Model implements IApp1DataCacheItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1DataCacheItem1Status = undefined as any;
  enabled: App1DataCacheItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp1DataCacheItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1DataCacheItem1 {
    return { ...this } as IApp1DataCacheItem1;
  }

  clone(): App1DataCacheItem1Model {
    return new App1DataCacheItem1Model(this.toJSON());
  }
