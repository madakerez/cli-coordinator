...
export class App3FeatureCollaborationItem3Model implements IApp3FeatureCollaborationItem3 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App3FeatureCollaborationItem3Status = undefined as any;
  enabled: App3FeatureCollaborationItem3Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App3FeatureCollaborationItem3Status = undefined as any;

  constructor(data?: Partial<IApp3FeatureCollaborationItem3>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp3FeatureCollaborationItem3 {
    return { ...this } as IApp3FeatureCollaborationItem3;
  }

  clone(): App3FeatureCollaborationItem3Model {
    return new App3FeatureCollaborationItem3Model(this.toJSON());
  }
