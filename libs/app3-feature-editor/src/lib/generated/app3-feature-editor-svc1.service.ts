...
export class App3FeatureEditorSvc1Service {
  cache = new Map<string, App3FeatureEditorSvc1CacheEntry<unknown>>();
  requestQueue: Array<() => Promise<void>> = [];
  processing = false;
  config: App3FeatureEditorSvc1ServiceConfig;

  constructor(config: App3FeatureEditorSvc1ServiceConfig) {
    this.config = config;
  }
