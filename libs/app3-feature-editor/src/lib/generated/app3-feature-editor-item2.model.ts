...
export class App3FeatureEditorItem2Model implements IApp3FeatureEditorItem2 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App3FeatureEditorItem2Status = undefined as any;
  enabled: App3FeatureEditorItem2Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;

  constructor(data?: Partial<IApp3FeatureEditorItem2>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp3FeatureEditorItem2 {
    return { ...this } as IApp3FeatureEditorItem2;
  }

  clone(): App3FeatureEditorItem2Model {
    return new App3FeatureEditorItem2Model(this.toJSON());
  }
