...
export class App4FeatureUsersItem6Model implements IApp4FeatureUsersItem6 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureUsersItem6Status = undefined as any;
  enabled: App4FeatureUsersItem6Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App4FeatureUsersItem6Status = undefined as any;
  category: App4FeatureUsersItem6Type = undefined as any;
  tags: string = undefined as any;
  config: number = undefined as any;

  constructor(data?: Partial<IApp4FeatureUsersItem6>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureUsersItem6 {
    return { ...this } as IApp4FeatureUsersItem6;
  }

  clone(): App4FeatureUsersItem6Model {
    return new App4FeatureUsersItem6Model(this.toJSON());
  }
