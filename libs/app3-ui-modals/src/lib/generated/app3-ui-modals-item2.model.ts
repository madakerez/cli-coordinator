...
export class App3UiModalsItem2Model implements IApp3UiModalsItem2 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App3UiModalsItem2Status = undefined as any;
  enabled: App3UiModalsItem2Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;

  constructor(data?: Partial<IApp3UiModalsItem2>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp3UiModalsItem2 {
    return { ...this } as IApp3UiModalsItem2;
  }

  clone(): App3UiModalsItem2Model {
    return new App3UiModalsItem2Model(this.toJSON());
  }
