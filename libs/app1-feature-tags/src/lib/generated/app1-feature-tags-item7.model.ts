...
export class App1FeatureTagsItem7Model implements IApp1FeatureTagsItem7 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureTagsItem7Status = undefined as any;
  enabled: App1FeatureTagsItem7Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App1FeatureTagsItem7Status = undefined as any;
  category: App1FeatureTagsItem7Type = undefined as any;
  tags: string = undefined as any;
  config: number = undefined as any;
  options: boolean = undefined as any;

  constructor(data?: Partial<IApp1FeatureTagsItem7>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureTagsItem7 {
    return { ...this } as IApp1FeatureTagsItem7;
  }

  clone(): App1FeatureTagsItem7Model {
    return new App1FeatureTagsItem7Model(this.toJSON());
  }
