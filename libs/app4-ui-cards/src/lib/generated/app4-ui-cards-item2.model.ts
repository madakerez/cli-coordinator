...
export class App4UiCardsItem2Model implements IApp4UiCardsItem2 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4UiCardsItem2Status = undefined as any;
  enabled: App4UiCardsItem2Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;

  constructor(data?: Partial<IApp4UiCardsItem2>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4UiCardsItem2 {
    return { ...this } as IApp4UiCardsItem2;
  }

  clone(): App4UiCardsItem2Model {
    return new App4UiCardsItem2Model(this.toJSON());
  }
