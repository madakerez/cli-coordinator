...
export class App1UtilStringsItem1Model implements IApp1UtilStringsItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1UtilStringsItem1Status = undefined as any;
  enabled: App1UtilStringsItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp1UtilStringsItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1UtilStringsItem1 {
    return { ...this } as IApp1UtilStringsItem1;
  }

  clone(): App1UtilStringsItem1Model {
    return new App1UtilStringsItem1Model(this.toJSON());
  }
