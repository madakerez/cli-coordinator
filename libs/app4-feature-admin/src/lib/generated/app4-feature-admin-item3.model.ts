...
export class App4FeatureAdminItem3Model implements IApp4FeatureAdminItem3 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureAdminItem3Status = undefined as any;
  enabled: App4FeatureAdminItem3Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App4FeatureAdminItem3Status = undefined as any;

  constructor(data?: Partial<IApp4FeatureAdminItem3>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureAdminItem3 {
    return { ...this } as IApp4FeatureAdminItem3;
  }

  clone(): App4FeatureAdminItem3Model {
    return new App4FeatureAdminItem3Model(this.toJSON());
  }
