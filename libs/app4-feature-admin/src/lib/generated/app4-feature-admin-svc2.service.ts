...
export class App4FeatureAdminSvc2Service {
  cache = new Map<string, App4FeatureAdminSvc2CacheEntry<unknown>>();
  requestQueue: Array<() => Promise<void>> = [];
  processing = false;
  config: App4FeatureAdminSvc2ServiceConfig;

  constructor(config: App4FeatureAdminSvc2ServiceConfig) {
    this.config = config;
  }
