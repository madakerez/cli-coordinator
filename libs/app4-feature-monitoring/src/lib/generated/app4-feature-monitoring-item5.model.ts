...
export class App4FeatureMonitoringItem5Model implements IApp4FeatureMonitoringItem5 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureMonitoringItem5Status = undefined as any;
  enabled: App4FeatureMonitoringItem5Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App4FeatureMonitoringItem5Status = undefined as any;
  category: App4FeatureMonitoringItem5Type = undefined as any;
  tags: string = undefined as any;

  constructor(data?: Partial<IApp4FeatureMonitoringItem5>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureMonitoringItem5 {
    return { ...this } as IApp4FeatureMonitoringItem5;
  }

  clone(): App4FeatureMonitoringItem5Model {
    return new App4FeatureMonitoringItem5Model(this.toJSON());
  }
