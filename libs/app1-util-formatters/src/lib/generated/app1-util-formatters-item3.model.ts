...
export class App1UtilFormattersItem3Model implements IApp1UtilFormattersItem3 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1UtilFormattersItem3Status = undefined as any;
  enabled: App1UtilFormattersItem3Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App1UtilFormattersItem3Status = undefined as any;

  constructor(data?: Partial<IApp1UtilFormattersItem3>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1UtilFormattersItem3 {
    return { ...this } as IApp1UtilFormattersItem3;
  }

  clone(): App1UtilFormattersItem3Model {
    return new App1UtilFormattersItem3Model(this.toJSON());
  }
