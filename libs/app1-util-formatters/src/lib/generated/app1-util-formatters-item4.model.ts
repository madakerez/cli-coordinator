...
export class App1UtilFormattersItem4Model implements IApp1UtilFormattersItem4 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1UtilFormattersItem4Status = undefined as any;
  enabled: App1UtilFormattersItem4Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App1UtilFormattersItem4Status = undefined as any;
  category: App1UtilFormattersItem4Type = undefined as any;

  constructor(data?: Partial<IApp1UtilFormattersItem4>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1UtilFormattersItem4 {
    return { ...this } as IApp1UtilFormattersItem4;
  }

  clone(): App1UtilFormattersItem4Model {
    return new App1UtilFormattersItem4Model(this.toJSON());
  }
