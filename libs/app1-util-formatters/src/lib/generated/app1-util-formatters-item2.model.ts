...
export class App1UtilFormattersItem2Model implements IApp1UtilFormattersItem2 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1UtilFormattersItem2Status = undefined as any;
  enabled: App1UtilFormattersItem2Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;

  constructor(data?: Partial<IApp1UtilFormattersItem2>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1UtilFormattersItem2 {
    return { ...this } as IApp1UtilFormattersItem2;
  }

  clone(): App1UtilFormattersItem2Model {
    return new App1UtilFormattersItem2Model(this.toJSON());
  }
