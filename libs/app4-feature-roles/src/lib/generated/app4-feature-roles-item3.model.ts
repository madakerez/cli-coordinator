...
export class App4FeatureRolesItem3Model implements IApp4FeatureRolesItem3 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureRolesItem3Status = undefined as any;
  enabled: App4FeatureRolesItem3Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App4FeatureRolesItem3Status = undefined as any;

  constructor(data?: Partial<IApp4FeatureRolesItem3>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureRolesItem3 {
    return { ...this } as IApp4FeatureRolesItem3;
  }

  clone(): App4FeatureRolesItem3Model {
    return new App4FeatureRolesItem3Model(this.toJSON());
  }
