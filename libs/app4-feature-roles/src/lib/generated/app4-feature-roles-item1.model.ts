...
export class App4FeatureRolesItem1Model implements IApp4FeatureRolesItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureRolesItem1Status = undefined as any;
  enabled: App4FeatureRolesItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp4FeatureRolesItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureRolesItem1 {
    return { ...this } as IApp4FeatureRolesItem1;
  }

  clone(): App4FeatureRolesItem1Model {
    return new App4FeatureRolesItem1Model(this.toJSON());
  }
