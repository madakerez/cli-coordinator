...
export class App1FeatureProfileItem6Model implements IApp1FeatureProfileItem6 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureProfileItem6Status = undefined as any;
  enabled: App1FeatureProfileItem6Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App1FeatureProfileItem6Status = undefined as any;
  category: App1FeatureProfileItem6Type = undefined as any;
  tags: string = undefined as any;
  config: number = undefined as any;

  constructor(data?: Partial<IApp1FeatureProfileItem6>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureProfileItem6 {
    return { ...this } as IApp1FeatureProfileItem6;
  }

  clone(): App1FeatureProfileItem6Model {
    return new App1FeatureProfileItem6Model(this.toJSON());
  }
