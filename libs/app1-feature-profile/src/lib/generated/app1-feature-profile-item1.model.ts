...
export class App1FeatureProfileItem1Model implements IApp1FeatureProfileItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureProfileItem1Status = undefined as any;
  enabled: App1FeatureProfileItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp1FeatureProfileItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureProfileItem1 {
    return { ...this } as IApp1FeatureProfileItem1;
  }

  clone(): App1FeatureProfileItem1Model {
    return new App1FeatureProfileItem1Model(this.toJSON());
  }
