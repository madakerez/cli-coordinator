...
export class App4FeatureImportItem5Model implements IApp4FeatureImportItem5 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureImportItem5Status = undefined as any;
  enabled: App4FeatureImportItem5Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App4FeatureImportItem5Status = undefined as any;
  category: App4FeatureImportItem5Type = undefined as any;
  tags: string = undefined as any;

  constructor(data?: Partial<IApp4FeatureImportItem5>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureImportItem5 {
    return { ...this } as IApp4FeatureImportItem5;
  }

  clone(): App4FeatureImportItem5Model {
    return new App4FeatureImportItem5Model(this.toJSON());
  }
