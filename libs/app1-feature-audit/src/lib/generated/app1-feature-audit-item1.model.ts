...
export class App1FeatureAuditItem1Model implements IApp1FeatureAuditItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureAuditItem1Status = undefined as any;
  enabled: App1FeatureAuditItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp1FeatureAuditItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureAuditItem1 {
    return { ...this } as IApp1FeatureAuditItem1;
  }

  clone(): App1FeatureAuditItem1Model {
    return new App1FeatureAuditItem1Model(this.toJSON());
  }
