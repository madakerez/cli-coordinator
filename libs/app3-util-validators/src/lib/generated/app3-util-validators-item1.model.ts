...
export class App3UtilValidatorsItem1Model implements IApp3UtilValidatorsItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App3UtilValidatorsItem1Status = undefined as any;
  enabled: App3UtilValidatorsItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp3UtilValidatorsItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp3UtilValidatorsItem1 {
    return { ...this } as IApp3UtilValidatorsItem1;
  }

  clone(): App3UtilValidatorsItem1Model {
    return new App3UtilValidatorsItem1Model(this.toJSON());
  }
