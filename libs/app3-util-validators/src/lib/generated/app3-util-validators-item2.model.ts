...
export function createApp3UtilValidatorsItem2(data: Partial<IApp3UtilValidatorsItem2> = {}): IApp3UtilValidatorsItem2 {
  return {
    id: '',
    name: '',
    label: '',
    ...
    updatedAt: new Date(),
    ...data,
  } as IApp3UtilValidatorsItem2;
}

export function validateApp3UtilValidatorsItem2(entity: IApp3UtilValidatorsItem2): string[] {
  const errors: string[] = [];
...
export function cloneApp3UtilValidatorsItem2(entity: IApp3UtilValidatorsItem2): IApp3UtilValidatorsItem2 {
  return { ...entity };
}