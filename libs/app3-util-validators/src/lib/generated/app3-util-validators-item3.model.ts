...
export class App3UtilValidatorsItem3Model implements IApp3UtilValidatorsItem3 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App3UtilValidatorsItem3Status = undefined as any;
  enabled: App3UtilValidatorsItem3Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App3UtilValidatorsItem3Status = undefined as any;

  constructor(data?: Partial<IApp3UtilValidatorsItem3>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp3UtilValidatorsItem3 {
    return { ...this } as IApp3UtilValidatorsItem3;
  }

  clone(): App3UtilValidatorsItem3Model {
    return new App3UtilValidatorsItem3Model(this.toJSON());
  }
