...
export class App2FeatureSearchItem2Model implements IApp2FeatureSearchItem2 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App2FeatureSearchItem2Status = undefined as any;
  enabled: App2FeatureSearchItem2Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;

  constructor(data?: Partial<IApp2FeatureSearchItem2>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp2FeatureSearchItem2 {
    return { ...this } as IApp2FeatureSearchItem2;
  }

  clone(): App2FeatureSearchItem2Model {
    return new App2FeatureSearchItem2Model(this.toJSON());
  }
