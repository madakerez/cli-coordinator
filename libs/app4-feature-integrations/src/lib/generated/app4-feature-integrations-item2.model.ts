...
export class App4FeatureIntegrationsItem2Model implements IApp4FeatureIntegrationsItem2 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureIntegrationsItem2Status = undefined as any;
  enabled: App4FeatureIntegrationsItem2Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;

  constructor(data?: Partial<IApp4FeatureIntegrationsItem2>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureIntegrationsItem2 {
    return { ...this } as IApp4FeatureIntegrationsItem2;
  }

  clone(): App4FeatureIntegrationsItem2Model {
    return new App4FeatureIntegrationsItem2Model(this.toJSON());
  }
