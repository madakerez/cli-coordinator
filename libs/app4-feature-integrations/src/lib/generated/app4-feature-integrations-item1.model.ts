...
export class App4FeatureIntegrationsItem1Model implements IApp4FeatureIntegrationsItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureIntegrationsItem1Status = undefined as any;
  enabled: App4FeatureIntegrationsItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp4FeatureIntegrationsItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureIntegrationsItem1 {
    return { ...this } as IApp4FeatureIntegrationsItem1;
  }

  clone(): App4FeatureIntegrationsItem1Model {
    return new App4FeatureIntegrationsItem1Model(this.toJSON());
  }
