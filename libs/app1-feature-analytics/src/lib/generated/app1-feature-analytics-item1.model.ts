...
export class App1FeatureAnalyticsItem1Model implements IApp1FeatureAnalyticsItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureAnalyticsItem1Status = undefined as any;
  enabled: App1FeatureAnalyticsItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp1FeatureAnalyticsItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureAnalyticsItem1 {
    return { ...this } as IApp1FeatureAnalyticsItem1;
  }

  clone(): App1FeatureAnalyticsItem1Model {
    return new App1FeatureAnalyticsItem1Model(this.toJSON());
  }
