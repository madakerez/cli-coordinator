...
export class App1FeatureAnalyticsItem7Model implements IApp1FeatureAnalyticsItem7 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureAnalyticsItem7Status = undefined as any;
  enabled: App1FeatureAnalyticsItem7Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App1FeatureAnalyticsItem7Status = undefined as any;
  category: App1FeatureAnalyticsItem7Type = undefined as any;
  tags: string = undefined as any;
  config: number = undefined as any;
  options: boolean = undefined as any;

  constructor(data?: Partial<IApp1FeatureAnalyticsItem7>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureAnalyticsItem7 {
    return { ...this } as IApp1FeatureAnalyticsItem7;
  }

  clone(): App1FeatureAnalyticsItem7Model {
    return new App1FeatureAnalyticsItem7Model(this.toJSON());
  }
