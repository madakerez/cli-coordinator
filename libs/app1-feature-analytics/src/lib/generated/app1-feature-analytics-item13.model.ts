...
export class App1FeatureAnalyticsItem13Model implements IApp1FeatureAnalyticsItem13 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureAnalyticsItem13Status = undefined as any;
  enabled: App1FeatureAnalyticsItem13Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp1FeatureAnalyticsItem13>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureAnalyticsItem13 {
    return { ...this } as IApp1FeatureAnalyticsItem13;
  }

  clone(): App1FeatureAnalyticsItem13Model {
    return new App1FeatureAnalyticsItem13Model(this.toJSON());
  }
