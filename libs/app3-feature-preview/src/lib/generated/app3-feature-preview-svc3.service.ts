...
import { IApp3FeaturePreviewItem5, App3FeaturePreviewItem5Model, App3FeaturePreviewItem5Status, App3FeaturePreviewItem5Filter } from './app3-feature-preview-item5.model';
...
export class App3FeaturePreviewSvc3Service {
  private cache = new Map<string, App3FeaturePreviewSvc3CacheEntry<unknown>>();
  private requestQueue: Array<() => Promise<void>> = [];
  private processing = false;

  constructor(private config: App3FeaturePreviewSvc3ServiceConfig) {}
