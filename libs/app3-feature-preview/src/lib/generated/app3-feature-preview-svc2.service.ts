...
export class App3FeaturePreviewSvc2Service {
  cache = new Map<string, App3FeaturePreviewSvc2CacheEntry<unknown>>();
  requestQueue: Array<() => Promise<void>> = [];
  processing = false;
  config: App3FeaturePreviewSvc2ServiceConfig;

  constructor(config: App3FeaturePreviewSvc2ServiceConfig) {
    this.config = config;
  }
