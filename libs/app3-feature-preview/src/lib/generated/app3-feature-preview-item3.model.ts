...
export class App3FeaturePreviewItem3Model implements IApp3FeaturePreviewItem3 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App3FeaturePreviewItem3Status = undefined as any;
  enabled: App3FeaturePreviewItem3Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App3FeaturePreviewItem3Status = undefined as any;

  constructor(data?: Partial<IApp3FeaturePreviewItem3>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp3FeaturePreviewItem3 {
    return { ...this } as IApp3FeaturePreviewItem3;
  }

  clone(): App3FeaturePreviewItem3Model {
    return new App3FeaturePreviewItem3Model(this.toJSON());
  }
