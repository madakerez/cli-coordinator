...
export class App4FeatureSsoItem1Model implements IApp4FeatureSsoItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureSsoItem1Status = undefined as any;
  enabled: App4FeatureSsoItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp4FeatureSsoItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureSsoItem1 {
    return { ...this } as IApp4FeatureSsoItem1;
  }

  clone(): App4FeatureSsoItem1Model {
    return new App4FeatureSsoItem1Model(this.toJSON());
  }
