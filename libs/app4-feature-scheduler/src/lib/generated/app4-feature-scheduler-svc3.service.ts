...
export class App4FeatureSchedulerSvc3Service {
  cache = new Map<string, App4FeatureSchedulerSvc3CacheEntry<unknown>>();
  requestQueue: Array<() => Promise<void>> = [];
  processing = false;
  config: App4FeatureSchedulerSvc3ServiceConfig;

  constructor(config: App4FeatureSchedulerSvc3ServiceConfig) {
    this.config = config;
  }
