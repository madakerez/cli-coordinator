...
export class App1FeatureDashboardSvc2Service {
  cache = new Map<string, App1FeatureDashboardSvc2CacheEntry<unknown>>();
  requestQueue: Array<() => Promise<void>> = [];
  processing = false;
  config: App1FeatureDashboardSvc2ServiceConfig;

  constructor(config: App1FeatureDashboardSvc2ServiceConfig) {
    this.config = config;
  }
