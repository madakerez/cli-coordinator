...
export class App1FeatureImportItem1Model implements IApp1FeatureImportItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureImportItem1Status = undefined as any;
  enabled: App1FeatureImportItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp1FeatureImportItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureImportItem1 {
    return { ...this } as IApp1FeatureImportItem1;
  }

  clone(): App1FeatureImportItem1Model {
    return new App1FeatureImportItem1Model(this.toJSON());
  }
