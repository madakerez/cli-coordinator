...
export class App1FeatureImportItem7Model implements IApp1FeatureImportItem7 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureImportItem7Status = undefined as any;
  enabled: App1FeatureImportItem7Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App1FeatureImportItem7Status = undefined as any;
  category: App1FeatureImportItem7Type = undefined as any;
  tags: string = undefined as any;
  config: number = undefined as any;
  options: boolean = undefined as any;

  constructor(data?: Partial<IApp1FeatureImportItem7>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureImportItem7 {
    return { ...this } as IApp1FeatureImportItem7;
  }

  clone(): App1FeatureImportItem7Model {
    return new App1FeatureImportItem7Model(this.toJSON());
  }
