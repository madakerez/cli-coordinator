...
export class App1FeatureImportItem2Model implements IApp1FeatureImportItem2 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureImportItem2Status = undefined as any;
  enabled: App1FeatureImportItem2Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;

  constructor(data?: Partial<IApp1FeatureImportItem2>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureImportItem2 {
    return { ...this } as IApp1FeatureImportItem2;
  }

  clone(): App1FeatureImportItem2Model {
    return new App1FeatureImportItem2Model(this.toJSON());
  }
