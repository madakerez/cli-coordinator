...
export class App1FeatureImportItem5Model implements IApp1FeatureImportItem5 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureImportItem5Status = undefined as any;
  enabled: App1FeatureImportItem5Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App1FeatureImportItem5Status = undefined as any;
  category: App1FeatureImportItem5Type = undefined as any;
  tags: string = undefined as any;

  constructor(data?: Partial<IApp1FeatureImportItem5>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureImportItem5 {
    return { ...this } as IApp1FeatureImportItem5;
  }

  clone(): App1FeatureImportItem5Model {
    return new App1FeatureImportItem5Model(this.toJSON());
  }
