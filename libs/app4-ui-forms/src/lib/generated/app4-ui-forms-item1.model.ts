...
export class App4UiFormsItem1Model implements IApp4UiFormsItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4UiFormsItem1Status = undefined as any;
  enabled: App4UiFormsItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp4UiFormsItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4UiFormsItem1 {
    return { ...this } as IApp4UiFormsItem1;
  }

  clone(): App4UiFormsItem1Model {
    return new App4UiFormsItem1Model(this.toJSON());
  }
