...
export class App4UiFormsItem5Model implements IApp4UiFormsItem5 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4UiFormsItem5Status = undefined as any;
  enabled: App4UiFormsItem5Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App4UiFormsItem5Status = undefined as any;
  category: App4UiFormsItem5Type = undefined as any;
  tags: string = undefined as any;

  constructor(data?: Partial<IApp4UiFormsItem5>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4UiFormsItem5 {
    return { ...this } as IApp4UiFormsItem5;
  }

  clone(): App4UiFormsItem5Model {
    return new App4UiFormsItem5Model(this.toJSON());
  }
