...
export class App4FeatureExportItem3Model implements IApp4FeatureExportItem3 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureExportItem3Status = undefined as any;
  enabled: App4FeatureExportItem3Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App4FeatureExportItem3Status = undefined as any;

  constructor(data?: Partial<IApp4FeatureExportItem3>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureExportItem3 {
    return { ...this } as IApp4FeatureExportItem3;
  }

  clone(): App4FeatureExportItem3Model {
    return new App4FeatureExportItem3Model(this.toJSON());
  }
