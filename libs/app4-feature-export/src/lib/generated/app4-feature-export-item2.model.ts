...
export class App4FeatureExportItem2Model implements IApp4FeatureExportItem2 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureExportItem2Status = undefined as any;
  enabled: App4FeatureExportItem2Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;

  constructor(data?: Partial<IApp4FeatureExportItem2>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureExportItem2 {
    return { ...this } as IApp4FeatureExportItem2;
  }

  clone(): App4FeatureExportItem2Model {
    return new App4FeatureExportItem2Model(this.toJSON());
  }
