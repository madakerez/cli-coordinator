...
export class App4FeatureAuditItem1Model implements IApp4FeatureAuditItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureAuditItem1Status = undefined as any;
  enabled: App4FeatureAuditItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp4FeatureAuditItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureAuditItem1 {
    return { ...this } as IApp4FeatureAuditItem1;
  }

  clone(): App4FeatureAuditItem1Model {
    return new App4FeatureAuditItem1Model(this.toJSON());
  }
