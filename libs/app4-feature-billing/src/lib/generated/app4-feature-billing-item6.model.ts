...
export class App4FeatureBillingItem6Model implements IApp4FeatureBillingItem6 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureBillingItem6Status = undefined as any;
  enabled: App4FeatureBillingItem6Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App4FeatureBillingItem6Status = undefined as any;
  category: App4FeatureBillingItem6Type = undefined as any;
  tags: string = undefined as any;
  config: number = undefined as any;

  constructor(data?: Partial<IApp4FeatureBillingItem6>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureBillingItem6 {
    return { ...this } as IApp4FeatureBillingItem6;
  }

  clone(): App4FeatureBillingItem6Model {
    return new App4FeatureBillingItem6Model(this.toJSON());
  }
