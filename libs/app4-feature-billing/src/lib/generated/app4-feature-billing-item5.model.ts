...
export class App4FeatureBillingItem5Model implements IApp4FeatureBillingItem5 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureBillingItem5Status = undefined as any;
  enabled: App4FeatureBillingItem5Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App4FeatureBillingItem5Status = undefined as any;
  category: App4FeatureBillingItem5Type = undefined as any;
  tags: string = undefined as any;

  constructor(data?: Partial<IApp4FeatureBillingItem5>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureBillingItem5 {
    return { ...this } as IApp4FeatureBillingItem5;
  }

  clone(): App4FeatureBillingItem5Model {
    return new App4FeatureBillingItem5Model(this.toJSON());
  }
