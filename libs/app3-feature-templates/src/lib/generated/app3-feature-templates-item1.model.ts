...
export class App3FeatureTemplatesItem1Model implements IApp3FeatureTemplatesItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App3FeatureTemplatesItem1Status = undefined as any;
  enabled: App3FeatureTemplatesItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp3FeatureTemplatesItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp3FeatureTemplatesItem1 {
    return { ...this } as IApp3FeatureTemplatesItem1;
  }

  clone(): App3FeatureTemplatesItem1Model {
    return new App3FeatureTemplatesItem1Model(this.toJSON());
  }
