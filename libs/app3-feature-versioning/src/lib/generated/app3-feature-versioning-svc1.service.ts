...
export class App3FeatureVersioningSvc1Service {
  cache = new Map<string, App3FeatureVersioningSvc1CacheEntry<unknown>>();
  requestQueue: Array<() => Promise<void>> = [];
  processing = false;
  config: App3FeatureVersioningSvc1ServiceConfig;

  constructor(config: App3FeatureVersioningSvc1ServiceConfig) {
    this.config = config;
  }
