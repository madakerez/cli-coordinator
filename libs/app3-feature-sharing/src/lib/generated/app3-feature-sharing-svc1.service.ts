...
export class App3FeatureSharingSvc1Service {
  cache = new Map<string, App3FeatureSharingSvc1CacheEntry<unknown>>();
  requestQueue: Array<() => Promise<void>> = [];
  processing = false;
  config: App3FeatureSharingSvc1ServiceConfig;

  constructor(config: App3FeatureSharingSvc1ServiceConfig) {
    this.config = config;
  }
