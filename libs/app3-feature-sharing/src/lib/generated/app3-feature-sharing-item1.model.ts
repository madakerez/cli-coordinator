...
export class App3FeatureSharingItem1Model implements IApp3FeatureSharingItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App3FeatureSharingItem1Status = undefined as any;
  enabled: App3FeatureSharingItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp3FeatureSharingItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp3FeatureSharingItem1 {
    return { ...this } as IApp3FeatureSharingItem1;
  }

  clone(): App3FeatureSharingItem1Model {
    return new App3FeatureSharingItem1Model(this.toJSON());
  }
