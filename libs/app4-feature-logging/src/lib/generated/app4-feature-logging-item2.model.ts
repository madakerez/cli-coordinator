...
export class App4FeatureLoggingItem2Model implements IApp4FeatureLoggingItem2 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureLoggingItem2Status = undefined as any;
  enabled: App4FeatureLoggingItem2Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;

  constructor(data?: Partial<IApp4FeatureLoggingItem2>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureLoggingItem2 {
    return { ...this } as IApp4FeatureLoggingItem2;
  }

  clone(): App4FeatureLoggingItem2Model {
    return new App4FeatureLoggingItem2Model(this.toJSON());
  }
