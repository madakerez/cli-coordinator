...
export class App4FeatureLoggingItem1Model implements IApp4FeatureLoggingItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureLoggingItem1Status = undefined as any;
  enabled: App4FeatureLoggingItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp4FeatureLoggingItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureLoggingItem1 {
    return { ...this } as IApp4FeatureLoggingItem1;
  }

  clone(): App4FeatureLoggingItem1Model {
    return new App4FeatureLoggingItem1Model(this.toJSON());
  }
