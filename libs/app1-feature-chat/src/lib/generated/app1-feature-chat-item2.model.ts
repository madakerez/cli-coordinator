...
export class App1FeatureChatItem2Model implements IApp1FeatureChatItem2 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureChatItem2Status = undefined as any;
  enabled: App1FeatureChatItem2Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;

  constructor(data?: Partial<IApp1FeatureChatItem2>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureChatItem2 {
    return { ...this } as IApp1FeatureChatItem2;
  }

  clone(): App1FeatureChatItem2Model {
    return new App1FeatureChatItem2Model(this.toJSON());
  }
