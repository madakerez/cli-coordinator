...
export class App2UtilFilteringItem1Model implements IApp2UtilFilteringItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App2UtilFilteringItem1Status = undefined as any;
  enabled: App2UtilFilteringItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp2UtilFilteringItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp2UtilFilteringItem1 {
    return { ...this } as IApp2UtilFilteringItem1;
  }

  clone(): App2UtilFilteringItem1Model {
    return new App2UtilFilteringItem1Model(this.toJSON());
  }
