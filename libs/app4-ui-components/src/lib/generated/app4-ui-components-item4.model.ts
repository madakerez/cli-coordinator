...
export class App4UiComponentsItem4Model implements IApp4UiComponentsItem4 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4UiComponentsItem4Status = undefined as any;
  enabled: App4UiComponentsItem4Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App4UiComponentsItem4Status = undefined as any;
  category: App4UiComponentsItem4Type = undefined as any;

  constructor(data?: Partial<IApp4UiComponentsItem4>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4UiComponentsItem4 {
    return { ...this } as IApp4UiComponentsItem4;
  }

  clone(): App4UiComponentsItem4Model {
    return new App4UiComponentsItem4Model(this.toJSON());
  }
