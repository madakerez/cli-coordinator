...
export class App4UiComponentsItem2Model implements IApp4UiComponentsItem2 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4UiComponentsItem2Status = undefined as any;
  enabled: App4UiComponentsItem2Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;

  constructor(data?: Partial<IApp4UiComponentsItem2>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4UiComponentsItem2 {
    return { ...this } as IApp4UiComponentsItem2;
  }

  clone(): App4UiComponentsItem2Model {
    return new App4UiComponentsItem2Model(this.toJSON());
  }
