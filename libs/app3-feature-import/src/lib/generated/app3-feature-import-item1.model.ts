...
export class App3FeatureImportItem1Model implements IApp3FeatureImportItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App3FeatureImportItem1Status = undefined as any;
  enabled: App3FeatureImportItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp3FeatureImportItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp3FeatureImportItem1 {
    return { ...this } as IApp3FeatureImportItem1;
  }

  clone(): App3FeatureImportItem1Model {
    return new App3FeatureImportItem1Model(this.toJSON());
  }
