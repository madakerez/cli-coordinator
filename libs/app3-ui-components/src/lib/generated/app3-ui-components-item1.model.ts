...
export class App3UiComponentsItem1Model implements IApp3UiComponentsItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App3UiComponentsItem1Status = undefined as any;
  enabled: App3UiComponentsItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp3UiComponentsItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp3UiComponentsItem1 {
    return { ...this } as IApp3UiComponentsItem1;
  }

  clone(): App3UiComponentsItem1Model {
    return new App3UiComponentsItem1Model(this.toJSON());
  }
