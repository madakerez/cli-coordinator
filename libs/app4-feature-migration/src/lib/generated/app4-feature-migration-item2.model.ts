...
export class App4FeatureMigrationItem2Model implements IApp4FeatureMigrationItem2 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureMigrationItem2Status = undefined as any;
  enabled: App4FeatureMigrationItem2Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;

  constructor(data?: Partial<IApp4FeatureMigrationItem2>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureMigrationItem2 {
    return { ...this } as IApp4FeatureMigrationItem2;
  }

  clone(): App4FeatureMigrationItem2Model {
    return new App4FeatureMigrationItem2Model(this.toJSON());
  }
