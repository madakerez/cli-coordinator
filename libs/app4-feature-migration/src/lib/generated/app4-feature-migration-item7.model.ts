...
export class App4FeatureMigrationItem7Model implements IApp4FeatureMigrationItem7 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4FeatureMigrationItem7Status = undefined as any;
  enabled: App4FeatureMigrationItem7Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App4FeatureMigrationItem7Status = undefined as any;
  category: App4FeatureMigrationItem7Type = undefined as any;
  tags: string = undefined as any;
  config: number = undefined as any;
  options: boolean = undefined as any;

  constructor(data?: Partial<IApp4FeatureMigrationItem7>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4FeatureMigrationItem7 {
    return { ...this } as IApp4FeatureMigrationItem7;
  }

  clone(): App4FeatureMigrationItem7Model {
    return new App4FeatureMigrationItem7Model(this.toJSON());
  }
