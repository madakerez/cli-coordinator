...
export class App1FeatureSearchItem3Model implements IApp1FeatureSearchItem3 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1FeatureSearchItem3Status = undefined as any;
  enabled: App1FeatureSearchItem3Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App1FeatureSearchItem3Status = undefined as any;

  constructor(data?: Partial<IApp1FeatureSearchItem3>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1FeatureSearchItem3 {
    return { ...this } as IApp1FeatureSearchItem3;
  }

  clone(): App1FeatureSearchItem3Model {
    return new App1FeatureSearchItem3Model(this.toJSON());
  }
