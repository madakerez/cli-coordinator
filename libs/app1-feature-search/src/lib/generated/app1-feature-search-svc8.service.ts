...
export class App1FeatureSearchSvc8Service {
  cache = new Map<string, App1FeatureSearchSvc8CacheEntry<unknown>>();
  requestQueue: Array<() => Promise<void>> = [];
  processing = false;
  config: App1FeatureSearchSvc8ServiceConfig;

  constructor(config: App1FeatureSearchSvc8ServiceConfig) {
    this.config = config;
  }
