...
export interface App3DataAccessSvc1ServiceConfig {
  baseUrl: string;
  apiKey: string;
  timeout: number;
...
export interface App3DataAccessSvc1CacheEntry<T> {
  data: T;
  timestamp: number;
  ttl: number;
  key: string;
...
export class App3DataAccessSvc1Service {
  private cache = new Map<string, App3DataAccessSvc1CacheEntry<unknown>>();
  private requestQueue: Array<() => Promise<void>> = [];
  private processing = false;

  constructor(private config: App3DataAccessSvc1ServiceConfig) {}
