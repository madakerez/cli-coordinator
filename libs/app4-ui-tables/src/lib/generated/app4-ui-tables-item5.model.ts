...
export class App4UiTablesItem5Model implements IApp4UiTablesItem5 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4UiTablesItem5Status = undefined as any;
  enabled: App4UiTablesItem5Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App4UiTablesItem5Status = undefined as any;
  category: App4UiTablesItem5Type = undefined as any;
  tags: string = undefined as any;

  constructor(data?: Partial<IApp4UiTablesItem5>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4UiTablesItem5 {
    return { ...this } as IApp4UiTablesItem5;
  }

  clone(): App4UiTablesItem5Model {
    return new App4UiTablesItem5Model(this.toJSON());
  }
