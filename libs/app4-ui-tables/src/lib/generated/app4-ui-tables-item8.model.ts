...
export class App4UiTablesItem8Model implements IApp4UiTablesItem8 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App4UiTablesItem8Status = undefined as any;
  enabled: App4UiTablesItem8Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;
  priority: App4UiTablesItem8Status = undefined as any;
  category: App4UiTablesItem8Type = undefined as any;
  tags: string = undefined as any;
  config: number = undefined as any;
  options: boolean = undefined as any;
  parentId: Date = undefined as any;

  constructor(data?: Partial<IApp4UiTablesItem8>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp4UiTablesItem8 {
    return { ...this } as IApp4UiTablesItem8;
  }

  clone(): App4UiTablesItem8Model {
    return new App4UiTablesItem8Model(this.toJSON());
  }
