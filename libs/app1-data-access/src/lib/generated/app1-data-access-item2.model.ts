...
export class App1DataAccessItem2Model implements IApp1DataAccessItem2 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1DataAccessItem2Status = undefined as any;
  enabled: App1DataAccessItem2Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;

  constructor(data?: Partial<IApp1DataAccessItem2>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1DataAccessItem2 {
    return { ...this } as IApp1DataAccessItem2;
  }

  clone(): App1DataAccessItem2Model {
    return new App1DataAccessItem2Model(this.toJSON());
  }
