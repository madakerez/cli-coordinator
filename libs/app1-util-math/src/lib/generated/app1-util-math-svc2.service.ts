...
import type { IApp1UtilMathItem4, App1UtilMathItem4Status } from './app1-util-math-item4.model';
...
export class App1UtilMathSvc2Service {
  cache = new Map<string, App1UtilMathSvc2CacheEntry<unknown>>();
  requestQueue: Array<() => Promise<void>> = [];
  processing = false;
  config: App1UtilMathSvc2ServiceConfig;

  constructor(config: App1UtilMathSvc2ServiceConfig) {
    this.config = config;
  }
