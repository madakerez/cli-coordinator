...
export class App1UtilMathItem2Model implements IApp1UtilMathItem2 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1UtilMathItem2Status = undefined as any;
  enabled: App1UtilMathItem2Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;
  metadata: Date = undefined as any;

  constructor(data?: Partial<IApp1UtilMathItem2>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1UtilMathItem2 {
    return { ...this } as IApp1UtilMathItem2;
  }

  clone(): App1UtilMathItem2Model {
    return new App1UtilMathItem2Model(this.toJSON());
  }
