...
export class App1UtilMathItem1Model implements IApp1UtilMathItem1 {
  id: string = undefined as any;
  name: number = undefined as any;
  label: boolean = undefined as any;
  value: Date = undefined as any;
  count: App1UtilMathItem1Status = undefined as any;
  enabled: App1UtilMathItem1Type = undefined as any;
  createdAt: string = undefined as any;
  updatedAt: number = undefined as any;
  description: boolean = undefined as any;

  constructor(data?: Partial<IApp1UtilMathItem1>) {
    if (data) Object.assign(this, data);
  }

  toJSON(): IApp1UtilMathItem1 {
    return { ...this } as IApp1UtilMathItem1;
  }

  clone(): App1UtilMathItem1Model {
    return new App1UtilMathItem1Model(this.toJSON());
  }
